...
*/
(function(){function U(a,d){a.prototype=Qa(d.prototype);a.prototype.constructor=a;a.base=d.prototype}function Qa(a){function d(){}d.prototype=a;return new d}function Ia(a,d,b){"millisecond"===b?a.setMilliseconds(a.getMilliseconds()+1*d):"second"===b?a.setSeconds(a.getSeconds()+1*d):"minute"===b?a.setMinutes(a.getMinutes()+1*d):"hour"===b?a.setHours(a.getHours()+1*d):"day"===b?a.setDate(a.getDate()+1*d):"week"===b?a.setDate(a.getDate()+7*d):"month"===b?a.setMonth(a.getMonth()+1*d):"year"===b&&a.setFullYear(a.getFullYear()+
...
0;c<b.length;c++)b[c]*=d;else b=[];return b}function K(a,d,b,c){if(a.addEventListener)a.addEventListener(d,b,c||!1);else if(a.attachEvent)a.attachEvent("on"+d,function(c){c=c||window.event;c.preventDefault=c.preventDefault||function(){c.returnValue=!1};c.stopPropagation=c.stopPropagation||function(){c.cancelBubble=!0};b.call(a,c)});else return!1}function Ma(a,d,b){a*=L;d*=L;a=b.getImageData(a,d,2,2).data;d=!0;for(b=0;4>b;b++)if(a[b]!==a[b+4]|a[b]!==a[b+8]|a[b]!==a[b+12]){d=!1;break}return d?a[0]<<
16|a[1]<<8|a[2]:0}function M(a,d,b){return a in d?d[a]:b[a]}function sa(a,d,b){if(v&&Na){var c=a.getContext("2d");ta=c.webkitBackingStorePixelRatio||c.mozBackingStorePixelRatio||c.msBackingStorePixelRatio||c.oBackingStorePixelRatio||c.backingStorePixelRatio||1;L=Ba/ta;a.width=d*L;a.height=b*L;Ba!==ta&&(a.style.width=d+"px",a.style.height=b+"px",c.scale(L,L))}else a.width=d,a.height=b}function Ta(a){if(!Ua){var d=!1,b=!1;"undefined"===typeof ga.Chart.creditHref?(a.creditHref="http://canvasjs.com/",
...
b&&(d.setAttribute("state",b),d.setAttribute("type","button"),d.style.position="relative",d.style.margin="0px 0px 0px 0px",d.style.padding="3px 4px 0px 4px",d.style.cssFloat="left",d.setAttribute("title",a._cultureInfo[b+"Text"]),d.innerHTML="<img style='height:16px;' src='"+Va[b].image+"' alt='"+a._cultureInfo[b+"Text"]+"' />")}function ua(){for(var a=null,d=0;d<arguments.length;d++)a=arguments[d],a.style&&(a.style.display="inline")}function $(){for(var a=null,d=0;d<arguments.length;d++)(a=arguments[d])&&
a.style&&(a.style.display="none")}function J(a,d,b,c){this._defaultsKey=a;this.parent=c;this._eventListeners=[];c={};b&&(ja[b]&&ja[b][a])&&(c=ja[b][a]);this.options=d?d:{_isPlaceholder:!0};this.setOptions(this.options,c)}function z(a,d){d=d||{};z.base.constructor.call(this,"Chart",d,d.theme?d.theme:"theme1");var b=this;this._containerId=a;this._objectsInitialized=!1;this.overlaidCanvasCtx=this.ctx=null;this._indexLabels=[];this._panTimerId=0;this._lastTouchEventType="";this._lastTouchData=null;this.isAnimating=
...
h=/[^-+\dA-Z]/g;return function(l,k,n){var m=n?n.days:d,p=n?n.months:c,e=n?n.shortDays:b,r=n?n.shortMonths:f;n="";var q=!1;l=l&&l.getTime?l:l?new Date(l):new Date;if(isNaN(l))throw SyntaxError("invalid date");"UTC:"===k.slice(0,4)&&(k=k.slice(4),q=!0);n=q?"getUTC":"get";var s=l[n+"Date"](),u=l[n+"Day"](),w=l[n+"Month"](),y=l[n+"FullYear"](),t=l[n+"Hours"](),v=l[n+"Minutes"](),aa=l[n+"Seconds"](),X=l[n+"Milliseconds"](),x=q?0:l.getTimezoneOffset();return n=k.replace(a,function(a){switch(a){case "D":return s;
...
2);case "f":return String(X).slice(0,1);case "ff":return P(String(X).slice(0,2),2);case "fff":return P(String(X).slice(0,3),3);case "t":return 12>t?"a":"p";case "tt":return 12>t?"am":"pm";case "T":return 12>t?"A":"P";case "TT":return 12>t?"AM":"PM";case "K":return q?"UTC":(String(l).match(g)||[""]).pop().replace(h,"");case "z":return(0<x?"-":"+")+Math.floor(Math.abs(x)/60);case "zz":return(0<x?"-":"+")+P(Math.floor(Math.abs(x)/60),2);case "zzz":return(0<x?"-":"+")+P(Math.floor(Math.abs(x)/60),2)+
P(Math.abs(x)%60,2);default:return a.slice(1,a.length-1)}})}}(),da=function(a,d,b){if(null===a)return"";a=Number(a);var c=0>a?!0:!1;c&&(a*=-1);var f=b?b.decimalSeparator:".",g=b?b.digitGroupSeparator:",",h="";d=String(d);var h=1,l=b="",k=-1,n=[],m=[],p=0,e=0,r=0,q=!1,s=0,l=d.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);d=null;for(var u=0;l&&u<l.length;u++)if(d=l[u],"."===d&&0>k)k=u;else{if("%"===d)h*=100;else if("\u2030"===d){h*=1E3;continue}else if(","===d[0]&&"."===d[d.length-1]){h/=
...
(ra(d),b=d.indexOf(this.options));this.options="undefined"===typeof a?{}:a;d[b]=this.options}else this.options="undefined"===typeof a?{}:a,a=this.parent.options,this.optionsName?d=this.optionsName:(d=this._defaultsKey)&&0!==d.length?(b=d.charAt(0).toLowerCase(),1<d.length&&(b=b.concat(d.slice(1))),d=b):d=void 0,a[d]=this.options};J.prototype.remove=function(a){a="undefined"===typeof a?!0:a;if(this.isOptionsInArray){var d=this.parent.options[this.optionsName];ra(d);var b=d.indexOf(this.options);0<=
b&&d.splice(b,1)}else delete this.parent.options[this.optionsName];a&&(chart=this.chart||this,chart.render())};J.prototype.updateOption=function(a){var d=ga[this._defaultsKey],b=this.options.theme?this.options.theme:this.chart&&this.chart.options.theme?this.chart.options.theme:"theme1",c={},f=this[a];b&&(ja[b]&&ja[b][this._defaultsKey])&&(c=ja[b][this._defaultsKey]);a in d&&(f=a in this.options?this.options[a]:c&&a in c?c[a]:d[a]);if(f===this[a])return!1;this[a]=f;return!0};J.prototype.trackChanges=
function(a){if(!this.sessionVariables)throw"Session Variable Store not set";this.sessionVariables[a]=this.options[a]};J.prototype.isBeingTracked=function(a){this.options._oldOptions||(this.options._oldOptions={});return this.options._oldOptions[a]?!0:!1};J.prototype.hasOptionChanged=function(a){if(!this.sessionVariables)throw"Session Variable Store not set";return this.sessionVariables[a]!==this.options[a]};J.prototype.addEventListener=function(a,d,b){a&&d&&(this._eventListeners[a]=this._eventListeners[a]||
[],this._eventListeners[a].push({context:b||this,eventHandler:d}))};J.prototype.removeEventListener=function(a,d){if(a&&d&&this._eventListeners[a])for(var b=this._eventListeners[a],c=0;c<b.length;c++)if(b[c].eventHandler===d){b[c].splice(c,1);break}};J.prototype.removeAllEventListeners=function(){this._eventListeners=[]};J.prototype.dispatchEvent=function(a,d,b){if(a&&this._eventListeners[a]){d=d||{};for(var c=this._eventListeners[a],f=0;f<c.length;f++)c[f].eventHandler.call(c[f].context,d)}"function"===
typeof this[a]&&this[a].call(b||this.chart,d)};U(z,J);z.prototype._updateOptions=function(){var a=this;this.updateOption("width");this.updateOption("height");this.updateOption("dataPointWidth");this.updateOption("dataPointMinWidth");this.updateOption("dataPointMaxWidth");this.updateOption("interactivityEnabled");this.updateOption("theme");this.updateOption("colorSet")&&(this._selectedColorSet="undefined"!==typeof ia[this.colorSet]?ia[this.colorSet]:ia.colorSet1);this.updateOption("backgroundColor");
this.backgroundColor||(this.backgroundColor="rgba(0,0,0,0)");this.updateOption("culture");this._cultureInfo=new pa(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&v;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.options.zoomEnabled?(this._zoomButton||($(this._zoomButton=document.createElement("button")),
T(this,this._zoomButton,"pan"),this._toolBar.appendChild(this._zoomButton),K(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,T(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,T(a,a._zoomButton,"pan"));a.render()})),this._resetButton||($(this._resetButton=document.createElement("button")),T(this,this._resetButton,"reset"),this._toolBar.appendChild(this._resetButton),K(this._resetButton,"click",function(){a.toolTip.hide();a.zoomEnabled||a.panEnabled?(a.zoomEnabled=
...
null;if(a.sessionVariables.axisY)for(b=0;b<a.sessionVariables.axisY.length;b++)a.sessionVariables.axisY[b].newViewportMinimum=null,a.sessionVariables.axisY[b].newViewportMaximum=null;if(a.sessionVariables.axisY2)for(b=0;b<a.sessionVariables.axisY2.length;b++)a.sessionVariables.axisY2[b].newViewportMinimum=null,a.sessionVariables.axisY2[b].newViewportMaximum=null;a.resetOverlayedCanvas();$(a._zoomButton,a._resetButton);a._dispatchRangeEvent("rangeChanging","reset");a.render();a._dispatchRangeEvent("rangeChanged",
"reset")}),this.overlaidCanvas.style.cursor=a._defaultCursor),this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),ua(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))):this.panEnabled=this.zoomEnabled=!1;this._menuButton?this.exportEnabled?ua(this._menuButton):$(this._menuButton):this.exportEnabled&&v&&(this._menuButton=document.createElement("button"),
T(this,this._menuButton,"menu"),this._toolBar.appendChild(this._menuButton),K(this._menuButton,"click",function(){"none"!==a._dropdownMenu.style.display||a._dropDownCloseTime&&500>=(new Date).getTime()-a._dropDownCloseTime.getTime()||(a._dropdownMenu.style.display="block",a._menuButton.blur(),a._dropdownMenu.focus())},!0));if(!this._dropdownMenu&&this.exportEnabled&&v){this._dropdownMenu=document.createElement("div");this._dropdownMenu.setAttribute("tabindex",-1);this._dropdownMenu.style.cssText=
...
a._dropDownCloseTime=new Date},!0);var d=document.createElement("div");d.style.cssText="padding: 2px 15px 2px 10px";d.innerHTML=this._cultureInfo.printText;this._dropdownMenu.appendChild(d);K(d,"mouseover",function(){this.style.backgroundColor="#EEEEEE"},!0);K(d,"mouseout",function(){this.style.backgroundColor="transparent"},!0);K(d,"click",function(){a.print();$(a._dropdownMenu)},!0);d=document.createElement("div");d.style.cssText="padding: 2px 15px 2px 10px";d.innerHTML=this._cultureInfo.saveJPGText;
this._dropdownMenu.appendChild(d);K(d,"mouseover",function(){this.style.backgroundColor="#EEEEEE"},!0);K(d,"mouseout",function(){this.style.backgroundColor="transparent"},!0);K(d,"click",function(){Ca(a.canvas,"jpeg",a.exportFileName);$(a._dropdownMenu)},!0);d=document.createElement("div");d.style.cssText="padding: 2px 15px 2px 10px";d.innerHTML=this._cultureInfo.savePNGText;this._dropdownMenu.appendChild(d);K(d,"mouseover",function(){this.style.backgroundColor="#EEEEEE"},!0);K(d,"mouseout",function(){this.style.backgroundColor=
"transparent"},!0);K(d,"click",function(){Ca(a.canvas,"png",a.exportFileName);$(a._dropdownMenu)},!0)}"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?T(a,a._zoomButton,"zoom"):T(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&T(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(var b in this.toolTip.options)this.toolTip.options.hasOwnProperty(b)&&
this.toolTip.updateOption(b)};z.prototype._updateSize=function(){var a=0,d=0;this.options.width?a=this.width:this.width=a=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?d=this.height:this.height=d=0<this.container.clientHeight?this.container.clientHeight:this.height;return this.canvas.width!==a*L||this.canvas.height!==d*L?(sa(this.canvas,a,d),sa(this.overlaidCanvas,a,d),sa(this._eventManager.ghostCanvas,a,d),!0):!1};z.prototype._initialize=function(){this._animator?
...
d,b){b=b||!1;for(var c=[],f=this._dataInRenderedOrder.length-1;0<=f;f--){var g=null;(g=this._dataInRenderedOrder[f].getDataPointAtXY(a,d,b))&&c.push(g)}a=null;d=!1;for(b=0;b<c.length;b++)if("line"===c[b].dataSeries.type||"stepLine"===c[b].dataSeries.type||"area"===c[b].dataSeries.type||"stepArea"===c[b].dataSeries.type)if(f=M("markerSize",c[b].dataPoint,c[b].dataSeries)||8,c[b].distance<=f/2){d=!0;break}for(b=0;b<c.length;b++)d&&"line"!==c[b].dataSeries.type&&"stepLine"!==c[b].dataSeries.type&&"area"!==
...
"zoom"),h&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(ua(this._zoomButton,this._resetButton),T(this,this._zoomButton,"pan"),T(this,this._resetButton,"reset")))}}this.isDrag=!1};z.prototype._plotAreaMouseMove=function(a,d){if(this.isDrag&&"none"!==this.plotInfo.axisPlacement){var b=0,c=0,f=b=null,f=0<=this.zoomType.indexOf("x"),g=0<=this.zoomType.indexOf("y"),h=this;"xySwapped"===this.plotInfo.axisPlacement&&(b=g,g=f,f=b);b=this.dragStartPoint.x-a;c=this.dragStartPoint.y-d;2<Math.abs(b)&&
...
a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new ka(a.x1,a.y1,a.x2,a.y2,2)};z.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,b=this.plotArea,c=0,f=0,g=0,h=0,l=c=h=f=g=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],m=n.chartType.toLowerCase(),p,e,l=M("indexLabelFontColor",n.dataPoint,n.dataSeries),k=M("indexLabelFontSize",n.dataPoint,n.dataSeries);p=M("indexLabelFontFamily",n.dataPoint,n.dataSeries);e=M("indexLabelFontStyle",
n.dataPoint,n.dataSeries);var h=M("indexLabelFontWeight",n.dataPoint,n.dataSeries),r=M("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),f=M("indexLabelMaxWidth",n.dataPoint,n.dataSeries),g=M("indexLabelWrap",n.dataPoint,n.dataSeries),q=M("indexLabelLineDashType",n.dataPoint,n.dataSeries),s=M("indexLabelLineColor",n.dataPoint,n.dataSeries),u=x(n.dataPoint.indexLabelLineThickness)?x(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,
...
n.dataPoint.indexLabelFormatter(y):n.dataPoint.indexLabel?this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?n.dataSeries.indexLabelFormatter(y):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==t&&""!==t){var w=M("indexLabelPlacement",n.dataPoint,n.dataSeries),y=M("indexLabelOrientation",n.dataPoint,n.dataSeries),v=n.direction,aa=
n.dataSeries.axisX,X=n.dataSeries.axisY,z=!1,r=new W(d,{x:0,y:0,maxWidth:f?f:0.5*this.width,maxHeight:g?5*k:1.5*k,angle:"horizontal"===y?0:-90,text:t,padding:0,backgroundColor:r,horizontalAlign:"left",fontSize:k,fontFamily:p,fontWeight:h,fontColor:l,fontStyle:e,textBaseline:"top"});r.measureText();n.dataSeries.indexLabelMaxWidth=r.maxWidth;if(0<=m.indexOf("line")||0<=m.indexOf("area")||0<=m.indexOf("bubble")||0<=m.indexOf("scatter")){if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum||
n.dataPoint.y<X.viewportMinimum||n.dataPoint.y>X.viewportMaximum)continue}else if(0<=m.indexOf("column")){if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum||n.bounds.y1>b.y2||n.bounds.y2<b.y1)continue}else if(0<=m.indexOf("bar")){if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum||n.bounds.x1>b.x2||n.bounds.x2<b.x1)continue}else if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum)continue;f=h=2;"horizontal"===y?(l=r.width,k=r.height):(k=r.width,
...
var z="solid";if(b.setLineDash){var A=F(m.nullDataLineDashType,m.lineThickness),z=m.lineDashType,Q=F(z,m.lineThickness);b.setLineDash(Q)}for(var I=!0;r<p.length;r++)if(u=p[r].x.getTime?p[r].x.getTime():p[r].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!I)))if("number"!==typeof p[r].y)m.connectNullData||(I||e)||d(),I=!0;else{q=a.axisX.convertValueToPixel(u);s=a.axisY.convertValueToPixel(p[r].y);e||I?(!e&&m.connectNullData?(b.setLineDash&&(m.options.nullDataLineDashType||
z===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(b.stroke(),z=m.nullDataLineDashType,b.setLineDash(A)),b.lineTo(q,s),v&&c.lineTo(q,s)):(b.beginPath(),b.moveTo(q,s),v&&(c.beginPath(),c.moveTo(q,s)),t={x:q,y:s}),I=e=!1):(b.lineTo(q,s),v&&c.lineTo(q,s),0==r%250&&d());r<p.length-1&&(X!==(p[r].lineColor||x)||z!==(p[r].lineDashType||m.lineDashType))&&(d(),X=p[r].lineColor||x,b.strokeStyle=X,b.setLineDash&&(p[r].lineDashType?(z=p[r].lineDashType,b.setLineDash(F(z,m.lineThickness))):(z=m.lineDashType,
b.setLineDash(Q))));var H=m.dataPointIds[r];this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:r,x1:q,y1:s};0!==p[r].markerSize&&(0<p[r].markerSize||0<m.markerSize)&&(u=m.getMarkerProperties(r,q,s,b),l=u.color,h.push(u),H=D(H),v&&h.push({x:q,y:s,ctx:c,type:u.type,size:u.size,color:H,borderColor:H,borderThickness:u.borderThickness}));(p[r].indexLabel||m.indexLabel||p[r].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",
...
!1;e<p.length;e++)if(r=p[e].x.getTime?p[e].x.getTime():p[e].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!q)))if("number"!==typeof p[e].y)0<e&&!q&&(m.connectNullData?b.setLineDash&&(0<y.length&&(m.options.nullDataLineDashType||!p[e-1].lineDashType))&&(y[y.length-1].newLineDashArray=A,z=m.nullDataLineDashType):(d(),y=[])),q=!0;else{r=a.axisX.convertValueToPixel(r);q=a.axisY.convertValueToPixel(p[e].y);var Q=m.dataPointIds[e];this._eventManager.objectMap[Q]=
{id:Q,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:r,y1:q};y[y.length]={x:r,y:q};e<p.length-1&&(x!==(p[e].lineColor||G)||z!==(p[e].lineDashType||m.lineDashType))&&(x=p[e].lineColor||G,y[y.length-1].newStrokeStyle=x,b.setLineDash&&(p[e].lineDashType?(z=p[e].lineDashType,y[y.length-1].newLineDashArray=F(z,m.lineThickness)):(z=m.lineDashType,y[y.length-1].newLineDashArray=R)));if(0!==p[e].markerSize&&(0<p[e].markerSize||0<m.markerSize)){var I=m.getMarkerProperties(e,r,q,b),l=I.color;
h.push(I);Q=D(Q);v&&h.push({x:r,y:q,ctx:c,type:I.type,size:I.size,color:Q,borderColor:Q,borderThickness:I.borderThickness})}(p[e].indexLabel||m.indexLabel||p[e].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[e],dataSeries:m,point:{x:r,y:q},direction:0>p[e].y===a.axisY.reversed?1:-1,color:t});q=!1}d();O.drawMarkers(h);m.markerColor=l}}b.restore();v&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,
...
dataSeriesIndex:n};h=D(h);c.fillStyle=h;var h=[],e=!0,r=0,q,s,u,w=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),y,t=null,G=!1;if(0<p.length){var x=m._colorSet[r%m._colorSet.length],z=m.lineColor=m.options.lineColor||x,A=z;b.fillStyle=x;b.strokeStyle=z;b.lineWidth=m.lineThickness;var R="solid";if(b.setLineDash){var Q=F(m.nullDataLineDashType,m.lineThickness),R=m.lineDashType,I=F(R,m.lineThickness);b.setLineDash(I)}for(;r<p.length;r++)if(u=p[r].x.getTime?p[r].x.getTime():
p[r].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!G))){var H=s;"number"!==typeof p[r].y?(m.connectNullData||(G||e)||d(),G=!0):(q=a.axisX.convertValueToPixel(u),s=a.axisY.convertValueToPixel(p[r].y),e||G?(!e&&m.connectNullData?(b.setLineDash&&(m.options.nullDataLineDashType||R===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(b.stroke(),R=m.nullDataLineDashType,b.setLineDash(Q)),b.lineTo(q,H),b.lineTo(q,s),v&&(c.lineTo(q,H),c.lineTo(q,s))):(b.beginPath(),
b.moveTo(q,s),v&&(c.beginPath(),c.moveTo(q,s)),t={x:q,y:s}),G=e=!1):(b.lineTo(q,H),v&&c.lineTo(q,H),b.lineTo(q,s),v&&c.lineTo(q,s),0==r%250&&d()),r<p.length-1&&(A!==(p[r].lineColor||z)||R!==(p[r].lineDashType||m.lineDashType))&&(d(),A=p[r].lineColor||z,b.strokeStyle=A,b.setLineDash&&(p[r].lineDashType?(R=p[r].lineDashType,b.setLineDash(F(R,m.lineThickness))):(R=m.lineDashType,b.setLineDash(I)))),H=m.dataPointIds[r],this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:r,
...
[];for(p=0;p<x.length;p++)y=x[p].x.getTime?x[p].x.getTime():x[p].x,t.dataPointIndexes[y]=p,w[y]||(n.push(y),w[y]=!0);n.sort(Aa)}for(h=0;h<a.dataSeriesIndexes.length;h++){y=a.dataSeriesIndexes[h];t=this.data[y];x=t.dataPoints;w=!0;k=[];p=t.id;this._eventManager.objectMap[p]={objectType:"dataSeries",dataSeriesIndex:y};p=D(p);u.fillStyle=p;if(0<n.length){var c=t._colorSet[0],z=t.lineColor=t.options.lineColor||c,X=z;b.fillStyle=c;b.strokeStyle=z;b.lineWidth=t.lineThickness;var A="solid";if(b.setLineDash){var R=
F(t.nullDataLineDashType,t.lineThickness),A=t.lineDashType,Q=F(A,t.lineThickness);b.setLineDash(Q)}for(var I=!0,p=0;p<n.length;p++){q=n[p];var H=null,H=0<=t.dataPointIndexes[q]?x[t.dataPointIndexes[q]]:{x:q,y:null};if(!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!t.connectNullData||!I)))if("number"!==typeof H.y)t.connectNullData||(I||w)||d(),I=!0;else{e=a.axisX.convertValueToPixel(q);var ea=l[q]?l[q]:0;if(a.axisY.logarithmic){m[q]=H.y+(m[q]?m[q]:0);if(0>=m[q])continue;r=a.axisY.convertValueToPixel(m[q])}else r=
a.axisY.convertValueToPixel(H.y),r-=ea;k.push({x:e,y:s-ea});l[q]=s-r;w||I?(!w&&t.connectNullData?(b.setLineDash&&(t.options.nullDataLineDashType||A===t.lineDashType&&t.lineDashType!==t.nullDataLineDashType)&&(b.stroke(),A=t.nullDataLineDashType,b.setLineDash(R)),b.lineTo(e,r),v&&u.lineTo(e,r)):(b.beginPath(),b.moveTo(e,r),v&&(u.beginPath(),u.moveTo(e,r))),I=w=!1):(b.lineTo(e,r),v&&u.lineTo(e,r),0==p%250&&(d(),b.moveTo(e,r),v&&u.moveTo(e,r),k.push({x:e,y:s-ea})));p<x.length-1&&(X!==(x[p].lineColor||
z)||A!==(x[p].lineDashType||t.lineDashType))&&(d(),b.beginPath(),b.moveTo(e,r),k.push({x:e,y:s-ea}),X=x[p].lineColor||z,b.strokeStyle=X,b.setLineDash&&(x[p].lineDashType?(A=x[p].lineDashType,b.setLineDash(F(A,t.lineThickness))):(A=t.lineDashType,b.setLineDash(Q))));if(0<=t.dataPointIndexes[q]){var fa=t.dataPointIds[t.dataPointIndexes[q]];this._eventManager.objectMap[fa]={id:fa,objectType:"dataPoint",dataSeriesIndex:y,dataPointIndex:t.dataPointIndexes[q],x1:e,y1:r}}0<=t.dataPointIndexes[q]&&0!==H.markerSize&&
(0<H.markerSize||0<t.markerSize)&&(q=t.getMarkerProperties(p,e,r,b),g=q.color,f.push(q),markerColor=D(fa),v&&f.push({x:e,y:r,ctx:u,type:q.type,size:q.size,color:markerColor,borderColor:markerColor,borderThickness:q.borderThickness}));(H.indexLabel||t.indexLabel||H.indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:H,dataSeries:t,point:{x:e,y:r},direction:0>x[p].y===a.axisY.reversed?1:-1,color:c})}}d();b.moveTo(e,r);v&&u.moveTo(e,r)}delete t.dataPointIndexes;
...
x[p].x.getTime?x[p].x.getTime():x[p].x,t.dataPointIndexes[y]=p,w[y]||(n.push(y),w[y]=!0);n.sort(Aa)}for(f=0;f<a.dataSeriesIndexes.length;f++){y=a.dataSeriesIndexes[f];t=this.data[y];x=t.dataPoints;w=!0;c=t.id;this._eventManager.objectMap[c]={objectType:"dataSeries",dataSeriesIndex:y};c=D(c);u.fillStyle=c;k=[];if(0<n.length){var c=t._colorSet[p%t._colorSet.length],z=t.lineColor=t.options.lineColor||c,X=z;b.fillStyle=c;b.strokeStyle=z;b.lineWidth=t.lineThickness;var A="solid";if(b.setLineDash){var R=
F(t.nullDataLineDashType,t.lineThickness),A=t.lineDashType,Q=F(A,t.lineThickness);b.setLineDash(Q)}for(var I=!0,p=0;p<n.length;p++){q=n[p];var H=null,H=0<=t.dataPointIndexes[q]?x[t.dataPointIndexes[q]]:{x:q,y:null};if(!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!t.connectNullData||!I)))if("number"!==typeof H.y)t.connectNullData||(I||w)||d(),I=!0;else{var ea;ea=0!==a.dataPointYSums[q]?100*(H.y/a.dataPointYSums[q]):0;e=a.axisX.convertValueToPixel(q);var fa=l[q]?l[q]:0;if(a.axisY.logarithmic){m[q]=
...
r),v&&u.moveTo(e,r),k.push({x:e,y:s-fa})));p<x.length-1&&(X!==(x[p].lineColor||z)||A!==(x[p].lineDashType||t.lineDashType))&&(d(),b.beginPath(),b.moveTo(e,r),k.push({x:e,y:s-fa}),X=x[p].lineColor||z,b.strokeStyle=X,b.setLineDash&&(x[p].lineDashType?(A=x[p].lineDashType,b.setLineDash(F(A,t.lineThickness))):(A=t.lineDashType,b.setLineDash(Q))));if(0<=t.dataPointIndexes[q]){var Ga=t.dataPointIds[t.dataPointIndexes[q]];this._eventManager.objectMap[Ga]={id:Ga,objectType:"dataPoint",dataSeriesIndex:y,dataPointIndex:t.dataPointIndexes[q],
x1:e,y1:r}}0<=t.dataPointIndexes[q]&&0!==H.markerSize&&(0<H.markerSize||0<t.markerSize)&&(q=t.getMarkerProperties(p,e,r,b),h=q.color,g.push(q),markerColor=D(Ga),v&&g.push({x:e,y:r,ctx:u,type:q.type,size:q.size,color:markerColor,borderColor:markerColor,borderThickness:q.borderThickness}));(H.indexLabel||t.indexLabel||H.indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:H,dataSeries:t,point:{x:e,y:r},direction:0>x[p].y===a.axisY.reversed?1:-1,color:c})}}d();
...
z=n.lineDashType,C=F(z,n.lineThickness);b.setLineDash(C)}for(var R=!0;e<m.length;e++)if(u=m[e].x.getTime?m[e].x.getTime():m[e].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!R)))if(null!==m[e].y&&m[e].y.length&&"number"===typeof m[e].y[0]&&"number"===typeof m[e].y[1]){r=a.axisX.convertValueToPixel(u);q=a.axisY.convertValueToPixel(m[e].y[0]);s=a.axisY.convertValueToPixel(m[e].y[1]);p||R?(n.connectNullData&&!p?(b.setLineDash&&(n.options.nullDataLineDashType||
z===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(l[l.length-1].newLineDashArray=C,z=n.nullDataLineDashType,b.setLineDash(A)),b.lineTo(r,q),v&&c.lineTo(r,q),l.push({x:r,y:s})):(b.beginPath(),b.moveTo(r,q),w={x:r,y:q},l=[],l.push({x:r,y:s}),v&&(c.beginPath(),c.moveTo(r,q))),R=p=!1):(b.lineTo(r,q),l.push({x:r,y:s}),v&&c.lineTo(r,q),0==e%250&&d());u=n.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:e,x1:r,y1:q,y2:s};e<m.length-
1&&(x!==(m[e].lineColor||t)||z!==(m[e].lineDashType||n.lineDashType))&&(d(),x=m[e].lineColor||t,l[l.length-1].newStrokeStyle=x,b.strokeStyle=x,b.setLineDash&&(m[e].lineDashType?(z=m[e].lineDashType,l[l.length-1].newLineDashArray=F(z,n.lineThickness),b.setLineDash(l[l.length-1].newLineDashArray)):(z=n.lineDashType,l[l.length-1].newLineDashArray=C,b.setLineDash(C))));if(0!==m[e].markerSize&&(0<m[e].markerSize||0<n.markerSize)){var Q=n.getMarkerProperties(e,r,s,b);f.push(Q);var I=D(u);v&&f.push({x:r,
y:s,ctx:c,type:Q.type,size:Q.size,color:I,borderColor:I,borderThickness:Q.borderThickness});Q=n.getMarkerProperties(e,r,q,b);g=Q.color;f.push(Q);I=D(u);v&&f.push({x:r,y:q,ctx:c,type:Q.type,size:Q.size,color:I,borderColor:I,borderThickness:Q.borderThickness})}if(m[e].indexLabel||n.indexLabel||m[e].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:m[e],dataSeries:n,indexKeyword:0,point:{x:r,y:q},direction:m[e].y[0]>m[e].y[1]===a.axisY.reversed?-1:1,color:y}),
this._indexLabels.push({chartType:"rangeArea",dataPoint:m[e],dataSeries:n,indexKeyword:1,point:{x:r,y:s},direction:m[e].y[0]>m[e].y[1]===a.axisY.reversed?1:-1,color:y})}else R||p||d(),R=!0;d();O.drawMarkers(f);n.markerColor=g}}b.restore();v&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,animationBase:0}}};z.prototype.renderRangeSplineArea=function(a){function d(a,d){var e=va(q,2);if(0<e.length){if(0<k.lineThickness){b.strokeStyle=
...
x)));if(0!==n[m].markerSize&&(0<n[m].markerSize||0<k.markerSize)){var C=k.getMarkerProperties(m,p,e,b),g=C.color;f.push(C);var R=D(A);v&&f.push({x:p,y:e,ctx:c,type:C.type,size:C.size,color:R,borderColor:R,borderThickness:C.borderThickness});C=k.getMarkerProperties(m,p,r,b);f.push(C);R=D(A);v&&f.push({x:p,y:r,ctx:c,type:C.type,size:C.size,color:R,borderColor:R,borderThickness:C.borderThickness})}if(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"splineArea",
...
this.borderColor);this.ctx.fillStyle=this.fontColor;for(b=0;b<this._wrappedText.lines.length;b++)g=this._wrappedText.lines[b],"right"===this.horizontalAlign?c=this.width-g.width-this.padding:"left"===this.horizontalAlign?c=this.padding:"center"===this.horizontalAlign&&(c=(this.width-2*this.padding)/2-g.width/2+this.padding),this.ctx.fillText(g.text,c,f),f+=g.height;this.ctx.font=d;a&&this.ctx.restore()};W.prototype.setText=function(a){this.text=a;this._isDirty=!0;this._wrappedText=null};W.prototype.measureText=
...
!1);h.height=this._lineHeight;d.push(h);var l=f,f=Math.max(f,h.width),c=c+h.height,a=la(a.slice(h.text.length,a.length));g&&c>g&&(h=d.pop(),c-=h.height,f=l)}this._wrappedText={lines:d,width:f,height:c};this.width=f+2*this.padding;this.height=c+2*this.padding;this.ctx.font=b};W.prototype._getFontString=function(){var a;a=""+(this.fontStyle?this.fontStyle+" ":"");a+=this.fontWeight?this.fontWeight+" ":"";a+=this.fontSize?this.fontSize+"px ":"";var d=this.fontFamily?this.fontFamily+"":"";!v&&d&&(d=d.split(",")[0],
"'"!==d[0]&&'"'!==d[0]&&(d="'"+d+"'"));return a+=d};U(na,J);na.prototype.render=function(){if(this.text){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),b=d.x1,c=d.y1,f=0,g=0,h=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,l,k;"top"===this.verticalAlign||"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=d.width-4-h*("center"===this.horizontalAlign?2:1)),g=0.5*d.height-this.margin-2,f=0):"center"===
...
2;e.x2=this.chart._eventManager.objectMap[e.id].x2=e.textBlock.x+e.textBlock.width;e.y2=this.chart._eventManager.objectMap[e.id].y2=e.textBlock.y+e.textBlock.height-this.lineHeight/2}d+=v}0<k.length&&a.layoutManager.registerSpace(b,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:f,y1:c,x2:f+this.width,y2:c+this.height}};U(Da,J);Da.prototype.render=function(){var a=this.chart.layoutManager.getFreeSpace();this.ctx.fillStyle="red";this.ctx.fillRect(a.x1,a.y1,a.x2,a.y2)};U(ba,J);ba.prototype.getDefaultAxisPlacement=
...
I;D=E=F=I=!1;if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&a[e].title&&(a[e]._titleTextBlock=new W(a[e].ctx,{text:a[e].title,horizontalAlign:"center",fontSize:a[e].titleFontSize,fontFamily:a[e].titleFontFamily,fontWeight:a[e].titleFontWeight,fontColor:a[e].titleFontColor,fontStyle:a[e].titleFontStyle,textBaseline:"top"}));if(d&&0<d.length)for(e=0;e<d.length;e++)d[e]&&d[e].title&&(d[e]._titleTextBlock=new W(d[e].ctx,{text:d[e].title,horizontalAlign:"center",fontSize:d[e].titleFontSize,fontFamily:d[e].titleFontFamily,
fontWeight:d[e].titleFontWeight,fontColor:d[e].titleFontColor,fontStyle:d[e].titleFontStyle,textBaseline:"top"}));if(b&&0<b.length)for(e=0;e<b.length;e++)b[e]&&b[e].title&&(b[e]._titleTextBlock=new W(b[e].ctx,{text:b[e].title,horizontalAlign:"center",fontSize:b[e].titleFontSize,fontFamily:b[e].titleFontFamily,fontWeight:b[e].titleFontWeight,fontColor:b[e].titleFontColor,fontStyle:b[e].titleFontStyle,textBaseline:"top"}));if(c&&0<c.length)for(e=0;e<c.length;e++)c[e]&&c[e].title&&(c[e]._titleTextBlock=
new W(c[e].ctx,{text:c[e].title,horizontalAlign:"center",fontSize:c[e].titleFontSize,fontFamily:c[e].titleFontFamily,fontWeight:c[e].titleFontWeight,fontColor:c[e].titleFontColor,fontStyle:c[e].titleFontStyle,textBaseline:"top"}));if("normal"===f){var u=[],w=[],v=[],t=[],H=[],J=[],K=[],N=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&a[e].title&&(a[e]._titleTextBlock.maxWidth=a[e].titleMaxWidth||g.width,a[e]._titleTextBlock.maxHeight=a[e].titleWrap?0.8*g.height:1.5*a[e].titleFontSize,a[e]._titleTextBlock.angle=
...
c[e].title&&(c[e]._titleTextBlock.maxWidth=c[e].titleMaxWidth||g.height,c[e]._titleTextBlock.maxHeight=c[e].titleWrap?0.8*g.width:1.5*c[e].titleFontSize,c[e]._titleTextBlock.angle=90);for(;4>r;){var L=0,O=0,P=0,M=0,Z=f=0,B=0,S=0,Y=0,V=0,U=0,T=0;if(b&&0<b.length)for(v=[],e=U=0;e<b.length;e++)v.push(Math.ceil(b[e]?b[e].createLabelsAndCalculateWidth():0)),U+=v[e],B+=b[e]?b[e].margin:0;else v.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));K.push(v);if(c&&0<c.length)for(t=[],e=T=0;e<c.length;e++)t.push(Math.ceil(c[e]?
c[e].createLabelsAndCalculateWidth():0)),T+=t[e],S+=c[e]?c[e].margin:0;else t.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));N.push(t);h=Math.round(g.x1+U+B);k=Math.round(g.x2-T-S>m.width-10?m.width-10:g.x2-T-S);if(a&&0<a.length)for(u=[],e=Y=0;e<a.length;e++)a[e]&&(a[e].lineCoordinates={}),a[e].lineCoordinates.width=Math.abs(k-h),a[e].title&&(a[e]._titleTextBlock.maxWidth=0<a[e].titleMaxWidth&&a[e].titleMaxWidth<a[e].lineCoordinates.width?a[e].titleMaxWidth:a[e].lineCoordinates.width),
u.push(Math.ceil(a[e]?a[e].createLabelsAndCalculateHeight():0)),Y+=u[e],f+=a[e]?a[e].margin:0;else u.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():0));H.push(u);if(d&&0<d.length)for(w=[],e=V=0;e<d.length;e++)d[e]&&(d[e].lineCoordinates={}),d[e].lineCoordinates.width=Math.abs(k-h),d[e].title&&(d[e]._titleTextBlock.maxWidth=0<d[e].titleMaxWidth&&d[e].titleMaxWidth<d[e].lineCoordinates.width?d[e].titleMaxWidth:d[e].lineCoordinates.width),w.push(Math.ceil(d[e]?d[e].createLabelsAndCalculateHeight():
0)),V+=w[e],Z+=d[e]?d[e].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));J.push(w);if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&(a[e].lineCoordinates.x1=h,a[e].lineCoordinates.x2=Math.round(g.x2-T-S>m.width-10?m.width-10:g.x2-T-S),a[e]._labels&&1<a[e]._labels.length&&(l=n=0,n=a[e]._labels[1],l="dateTime"===a[e].chart.plotInfo.axisXValueType?a[e]._labels[a[e]._labels.length-2]:a[e]._labels[a[e]._labels.length-1],q=n.textBlock.width*Math.cos(Math.PI/180*Math.abs(n.textBlock.angle))+
(n.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(n.textBlock.angle)),s=l.textBlock.width*Math.cos(Math.PI/180*Math.abs(l.textBlock.angle))+(l.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(l.textBlock.angle))),a[e]&&(a[e].labelAutoFit&&!x(z)&&!x(A))&&(l=0,0<a[e].labelAngle?A+s>k&&(l+=0<a[e].labelAngle?A+s-k-T:0):0>a[e].labelAngle?z-q<h&&z-q<a[e].viewportMinimum&&(C=h-(B+a[e].tickLength+v+z-q+a[e].labelFontSize/2)):0===a[e].labelAngle&&(A+s>k&&(l=A+
s/2-k-T),z-q<h&&z-q<a[e].viewportMinimum&&(C=h-B-a[e].tickLength-v-z+q/2)),a[e].viewportMaximum===a[e].maximum&&a[e].viewportMinimum===a[e].minimum&&0<a[e].labelAngle&&0<l?k-=l:a[e].viewportMaximum===a[e].maximum&&a[e].viewportMinimum===a[e].minimum&&0>a[e].labelAngle&&0<C?h+=C:a[e].viewportMaximum===a[e].maximum&&a[e].viewportMinimum===a[e].minimum&&0===a[e].labelAngle&&(0<C&&(h+=C),0<l&&(k-=l))),m.panEnabled?Y=m.sessionVariables.axisX.height:m.sessionVariables.axisX.height=Y,l=Math.round(g.y2-Y-
f+L),n=Math.round(g.y2),a[e].lineCoordinates.x2=k,a[e].lineCoordinates.width=k-h,a[e].lineCoordinates.y1=l,a[e].lineCoordinates.y2=l,a[e].bounds={x1:h,y1:l,x2:k,y2:n-(Y+f-u[e]-L),width:k-h,height:n-l}),L+=u[e]+a[e].margin;if(d&&0<d.length)for(e=0;e<d.length;e++)d[e].lineCoordinates.x1=Math.round(g.x1+U+B),d[e].lineCoordinates.x2=Math.round(g.x2-T-S>m.width-10?m.width-10:g.x2-T-S),d[e].lineCoordinates.width=Math.abs(k-h),d[e]._labels&&1<d[e]._labels.length&&(n=d[e]._labels[1],l="dateTime"===d[e].chart.plotInfo.axisXValueType?
...
n=Math.round(g.y2+d[e].margin),d[e].lineCoordinates.y1=l+V+Z-O,d[e].lineCoordinates.y2=l,d[e].bounds={x1:h,y1:l+(V+Z-w[e]-O),x2:k,y2:n,width:k-h,height:n-l},O+=w[e]+d[e].margin;if(b&&0<b.length)for(e=0;e<b.length;e++)B=10,b[e]&&(h=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),B=b[e]._labels&&0<b[e]._labels.length?b[e]._labels[b[e]._labels.length-1].textBlock.height/2:10,l=Math.round(g.y1+V+Z<Math.max(B,10)?Math.max(B,10):g.y1+V+Z),k=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),
...
if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].calculateValueToPixelConversionParameters();if(0<r){if(a&&0<a.length)for(e=0;e<a.length;e++)D=H[r-1][e]===H[r][e]?!0:!1;else D=!0;if(d&&0<d.length)for(e=0;e<d.length;e++)E=J[r-1][e]===J[r][e]?!0:!1;else E=!0;if(b&&0<b.length)for(e=0;e<b.length;e++)F=K[r-1][e]===K[r][e]?!0:!1;else F=!0;if(c&&0<c.length)for(e=0;e<c.length;e++)I=N[r-1][e]===N[r][e]?!0:!1;else I=!0}if(D&&E&&F&&I)break;r++}p.save();p.beginPath();a[0]&&p.rect(5,a[0].bounds.y1,a[0].chart.width-
10,a[0].bounds.height);d[0]&&p.rect(5,d[d.length-1].bounds.y1,d[0].chart.width-10,d[0].bounds.height);p.clip();if(a&&0<a.length)for(e=0;e<a.length;e++)a[e].renderLabelsTicksAndTitle();if(d&&0<d.length)for(e=0;e<d.length;e++)d[e].renderLabelsTicksAndTitle();p.restore();if(b&&0<b.length)for(e=0;e<b.length;e++)b[e].renderLabelsTicksAndTitle();if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].renderLabelsTicksAndTitle()}else{z=[];A=[];C=[];q=[];s=[];H=[];J=[];K=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&
...
l);this.ctx.stroke();this.ctx.globalAlpha=c}this.ctx.restore()};U(S,J);S.prototype._initialize=function(){if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height="auto";this.container.style.boxShadow="1px 1px 2px 2px rgba(0,0,0,0.1)";this.container.style.zIndex="1000";this.container.style.display="none";var a;a='<div style=" width: auto;height: auto;min-width: 50px;';
...
a){var b=d.dest,c=d.source.canvas,f=d.animationBase;b.drawImage(c,0,0,c.width,c.height,0,f-f*a,b.canvas.width/L,a*b.canvas.height/L)}},xScaleAnimation:function(a,d){if(0!==a){var b=d.dest,c=d.source.canvas,f=d.animationBase;b.drawImage(c,0,0,c.width,c.height,f-f*a,0,a*b.canvas.width/L,b.canvas.height/L)}},xClipAnimation:function(a,d){if(0!==a){var b=d.dest,c=d.source.canvas;b.save();0<a&&b.drawImage(c,0,0,c.width*a,c.height,0,0,c.width*a/L,c.height/L);b.restore()}},fadeInAnimation:function(a,d){if(0!==
a){var b=d.dest,c=d.source.canvas;b.save();b.globalAlpha=a;b.drawImage(c,0,0,c.width,c.height,0,0,b.canvas.width/L,b.canvas.height/L);b.restore()}},easing:{linear:function(a,d,b,c){return b*a/c+d},easeOutQuad:function(a,d,b,c){return-b*(a/=c)*(a-2)+d},easeOutQuart:function(a,d,b,c){return-b*((a=a/c-1)*a*a*a-1)+d},easeInQuad:function(a,d,b,c){return b*(a/=c)*a+d},easeInQuart:function(a,d,b,c){return b*(a/=c)*a*a*a+d}}},O={drawMarker:function(a,d,b,c,f,g,h,l){if(b){var k=1;b.fillStyle=g?g:"#000000";
...
d){qa[a]=d},formatNumber:function(a,d,b){b=b||"en";if(qa[b])return da(a,d||"#,##0.##",new pa(b));throw"Unknown Culture Name";},formatDate:function(a,d,b){b=b||"en";if(qa[b])return Fa(a,d||"DD MMM YYYY",new pa(b));throw"Unknown Culture Name";}};Pa.Chart.version="v1.9.6 Beta-1";window.CanvasJS=Pa})();
/*
