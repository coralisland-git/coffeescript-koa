...
class BlockyHelper
    ...
    render: (@divBlocklyArea)=>
        ...
        ##|  Setup Blockly
        w = $(window).width - 40;
        @elBlocklyDiv = $ "<div id='blocklyDiv' style='width: #{w}px; height: 5000px;'/>"
        @elBlocklyDiv.css "position", "absolute"

        @divBlocklyArea.html ""
        @divBlocklyArea.append @elBlocklyDiv

        @workspace = Blockly.inject @elBlocklyDiv[0],
